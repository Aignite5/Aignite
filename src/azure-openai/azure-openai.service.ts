...
### Skill Gaps to Work On
### 5-Year Milestone Roadmap (Year 1–5, with 3–4 milestones each)

✨ IMPORTANT:
Do NOT include any “Suggested Career Pathways” — those are generated by another endpoint.
...
Use inspiring, confident, motivating tone. All content must feel custom-written for someone pursuing **${careerTitle}**.`;
